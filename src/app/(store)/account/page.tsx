...
function AccountPageContent() {
    ...
    const initialTab = (['overview', 'orders', 'addresses'] as const).includes(searchParams.get('tab') as 'overview' | 'orders' | 'addresses')
        ? (searchParams.get('tab') as 'overview' | 'orders' | 'addresses')
        : 'overview';
    const [activeTab, setActiveTab] = useState<'overview' | 'orders' | 'addresses'>(initialTab);
