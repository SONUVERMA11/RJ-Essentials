        ...
        <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className="bg-card rounded-lg p-4 shadow-sm">
                    <h2 className="font-bold text-foreground mb-4 flex items-center gap-2"><Package size={18} /> Orders by Status</h2>
                ...
                {/* Top Cities */}
                <div className="bg-card rounded-lg p-4 shadow-sm">
                    <h2 className="font-bold text-foreground mb-4 flex items-center gap-2"><MapPin size={18} /> Top Cities</h2>
                    <div className="space-y-2">
                ...
                {/* Top Products */}
                <div className="bg-card rounded-lg p-4 shadow-sm lg:col-span-2">
                    <h2 className="font-bold text-foreground mb-4 flex items-center gap-2"><TrendingUp size={18} /> Top Selling Products</h2>
                            ...
                            <tbody>
                                {(data.topProducts || []).map(p => (
                                    <tr key={p._id} className="border-b border-gray-50">
                                        <td className="py-2 text-foreground">{p._id}</td>
